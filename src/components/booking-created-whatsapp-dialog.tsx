    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] w-full max-w-lg overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            تم إنشاء الطلب بنجاح. الرسالة معبأة ببيانات الرحلة (من غير اسم العميل أو رقمه — هوية العميل لا تُرسل لشركات التنفيذ). أرسلها مباشرة لشركة تنفيذ أو بدون تحديد شركة لاختيار جهة الاتصال من داخل واتساب. يبقى كل شيء متوقفًا حتى تعود وتتابع يدويًا.
          </DialogDescription>
        </DialogHeader>
